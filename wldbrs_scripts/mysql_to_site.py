...
def add_on_site(item_id, brand_name, goods_name, img, url, price_now, price_prev, price_min, price_max,
                b_count, stars, company_name, product_type, product_type_name):
    def connect_db():
        ...
        execute_db(
            ...
            INSERT INTO
                {tablename} (item_id, brand_name, goods_name, img, url, price_now, price_prev, price_min, 
                                   price_max, b_count, stars, company_name, product_type, product_type_name, updated_time)
            VALUES
                ({item_id}, '{brand_name}', '{goods_name}', '{img}', '{url}', {price_now}, {price_prev}, {price_min}, 
                {price_max}, {b_count}, {stars}, '{company_name}', '{product_type}', '{product_type_name}', now())
            """
        )
        print('Inserting...')
    else:
